...
node ('DanaNode') {
  ...
  try{
    stage('CloneRepos') {
      parallel (
        "rails clone": new SourceClone().cloneSourceCode('DanaNodeBAD','ssh://git@github.com/rails/rails.git','rails',"${env.DANA_TEST_CREDENTIALS}","${env.RAILS_BRANCH}"),
        ...
        "bootstrap clone": new SourceClone().cloneSourceCode('DanaNodeBAD','ssh://git@github.com/twbs/bootstrap.git','bootstrap',"${env.DANA_TEST_CREDENTIALS}","${env.BOOTSTRAP_BRANCH}"),
        ...
        "angular.js clone": new SourceClone().cloneSourceCode('DanaNodeBAD','ssh://git@github.com/angular/angular.js.git','angular.js',"${env.DANA_TEST_CREDENTIALS}","${env.ANGULARJS_BRANCH}")
      )
    }
  } catch (Exception e){
    throw e
